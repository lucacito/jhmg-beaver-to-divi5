...
$free = __DIR__ . '/../plugin/jhmg-converter-for-beaver-builder-to-divi/jhmg-converter-for-beaver-builder-to-divi.php';
if ( file_exists( $free ) ) {
    require_once $free;
}
$pro = __DIR__ . '/../plugin/jhmg-converter-for-beaver-builder-to-divi-pro/jhmg-converter-for-beaver-builder-to-divi-pro.php';
if ( file_exists( $pro ) ) {
    require_once $pro;
}
