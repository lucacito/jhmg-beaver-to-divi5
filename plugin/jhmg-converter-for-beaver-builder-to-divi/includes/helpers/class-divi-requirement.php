    ...
    public static function message(): string {
        ...
        if ( $reason === 'missing' ) {
            return sprintf(
                ...
                __( 'Beaver Builder to Divi 5 Converter is inactive: Divi %s or newer is required, and no Divi installation was found. Converted pages would be saved in a format nothing on this site can render.', 'jhmg-converter-for-beaver-builder-to-divi' ),
        ...
        if ( $reason === 'too_old' ) {
            return sprintf(
                ...
                __( 'Beaver Builder to Divi 5 Converter is inactive: this site runs Divi %1$s, and the converter writes Divi 5 block content that requires Divi %2$s or newer. Converting now would produce pages that render blank.', 'jhmg-converter-for-beaver-builder-to-divi' ),
