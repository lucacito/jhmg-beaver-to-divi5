...
class LicenseClient {
    ...
    public function status_notice(): void {
        ...
        if ( ! $key ) {
            $this->render_notice(
                'notice-warning',
                __( 'JHMG Converter Pro: activate your license to receive automatic updates and support.', 'jhmg-converter-for-beaver-builder-to-divi-pro' ),
                __( 'Activate now', 'jhmg-converter-for-beaver-builder-to-divi-pro' ),
                $license_url
            );
            return;
        }
        ...
        if ( in_array( $status, [ 'expired', 'canceled' ], true ) ) {
            $this->render_notice(
                'notice-warning',
                __( 'JHMG Converter Pro: your license has expired. Renew to keep receiving updates.', 'jhmg-converter-for-beaver-builder-to-divi-pro' ),
                __( 'Renew', 'jhmg-converter-for-beaver-builder-to-divi-pro' ),
                $license_url
            );
            return;
        }
        ...
        if ( get_option( $this->opt_blocked ) ) {
            $this->render_notice(
                'notice-info',
                __( 'JHMG Converter Pro: an update is available. Renew your license to receive it.', 'jhmg-converter-for-beaver-builder-to-divi-pro' ),
                __( 'Renew', 'jhmg-converter-for-beaver-builder-to-divi-pro' ),
                $license_url
            );
        }
